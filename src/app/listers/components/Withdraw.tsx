"use client";
// ENDPOINTS: POST /api/listers/wallet/withdraw, GET /api/listers/wallet/bank-accounts
  ...
  return (
    <>
      ...
      <button
        ...
        className="flex-1 px-6 py-3 flex items-center justify-center space-x-1 text-sm font-semibold bg-[#F6F6F3] text-black rounded-lg hover:bg-[#444444] transition duration-150"
      >
