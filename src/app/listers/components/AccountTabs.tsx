...
// ENDPOINTS: GET /api/listers/profile, PUT /api/listers/profile, GET /api/listers/profile/business, PUT /api/listers/profile/business, GET /api/listers/notifications/preferences, PUT /api/listers/notifications/preferences, GET /api/listers/verifications/status, POST /api/listers/security/password
...
const BusinessDetailsContent: React.FC = () => (
  <motion.div
    variants={tabContentVariants}
    initial="initial"
    animate="enter"
...
const AccountTabs: React.FC = () => {
  ...
  const contentMap: Record<TabKey, React.ReactNode> = {
    ...
    business: <BusinessDetailsContent key="business" />,
