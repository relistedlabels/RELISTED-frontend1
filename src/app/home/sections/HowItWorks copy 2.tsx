              ...
              <motion.div
                className={`w-20 h-20 rounded-full flex items-center justify-center font-bold text-xl transition-all relative ${
                  activeStep === index
                    ...
                    : index < activeStep
                      ? "bg-gradient-to-br from-black gray-700 to-black  text-white"
        ...
        <div className="flex flex-col gap-3">
          {steps.map((step, index) => (
            <motion.button
              key={step.id}
              onClick={() => setActiveStep(index)}
              className={`p-5 sm:p-6  text-left transition-all duration-300 ${
                activeStep === index
                  ? "bg-gradient-to-r from-black gray-800 to-black text-white shadow-2xl"
        ...
        >
          ...
          <div className="w-full mt-10 space-y-3 relative z-10">
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <motion.div
                className="h-full bg-gradient-to-r from-black gray-800 to-gray-900 rounded-full"
                initial={{ width: "0%" }}
                animate={{
            ...
            <div className="flex flex-col items-center gap-2">
              <Paragraph3 className="text-gray-800 font-semibold">
          ...
          <div key={step.id}>
            ...
            <motion.button
              ...
              className={`w-full p-5 sm:p-6 rounded-2xl text-left transition-all duration-300 ${
                activeStep === index
                  ? "bg-gradient-to-r from-black gray-800 to-black text-white shadow-2xl rounded-b-none"
                  : "bg-white text-gray-900 hover:bg-gray-50 border border-gray-200 hover:border-gray-400"
              }`}
