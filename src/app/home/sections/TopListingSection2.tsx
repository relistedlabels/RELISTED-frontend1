    ...
    <section className="bg-white px-4 sm:px-0 py-6 sm:py-12">
      ...
      <div className="mx-auto container">
        ...
        <div className="flex justify-center items-center mt-2 w-full">
          <Link
            href={`/shop?tags=${encodeURIComponent("Vacation Outfits")}&title=${encodeURIComponent("VACATION OUTFITS")}&description=${encodeURIComponent("Explore amazing outfits that elevate your looks for your vacation and short trips")}`}
