...
export default function PlatformControlsTab() {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleCommissionFeesChange("platformCommission", e.target.value)
              }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleEscrowPayoutChange("escrowReleaseDelay", e.target.value)
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900"
            />
          </div>
      ...
      {/* KYC Requirements */}
      <div>
        <Paragraph3 className="text-gray-900 mb-6">KYC Requirements</Paragraph3>
      ...
      {/* Platform Access */}
      <div>
        <Paragraph3 className="text-gray-900 mb-6">Platform Access</Paragraph3>
        <div className="space-y-4 mb-6">
          <div className="p-4 border border-gray-200 rounded-lg flex items-center justify-between">
            <div>
              <Paragraph1 className="text-gray-900 font-medium">
            ...
            <button
              onClick={() => handlePlatformAccessToggle("allowCuratorSignup")}
              className={`relative inline-flex items-center h-8 w-14 rounded-full transition-colors ${
          ...
          <div className="p-4 border border-gray-200 rounded-lg flex items-center justify-between">
            ...
            <button
              onClick={() => handlePlatformAccessToggle("allowDresserSignup")}
              className={`relative inline-flex items-center h-8 w-14 rounded-full transition-colors ${
