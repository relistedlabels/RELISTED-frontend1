...
import { useDeleteProduct } from "@/lib/mutations/product/useDeleteProduct";
  ...
  return (
    <>
      <button
        ...
        className="w-full px-4 py-2 border border-red-400 text-red-500 rounded-lg font-semibold hover:bg-red-50 transition mt-2"
      >
