...
export default function AdminDetailsCard({ user }: AdminDetailsCardProps) {
  return (
    <div className="bg-white p-6 w-full max-w-sm border border-gray-200 rounded-2xl shadow-sm">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex flex-col gap-1 flex-1">
          ...
          <div className="mt-1 px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full w-fit">
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        <Paragraph3 className="text-xs font-bold mb-2 text-blue-600 uppercase tracking-wide">
          Admin Details
        </Paragraph3>
        <Paragraph1 className="text-xs text-blue-600">
          This user has administrative privileges on the RELISTED platform.
        </Paragraph1>
      </div>
    </div>
  );
